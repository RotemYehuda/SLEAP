...
NODE_IDX_L_FRONT_LEG  = _node_idx("L_front_leg", 5)
NODE_IDX_R_FRONT_LEG  = _node_idx("R_front_leg", 6)
NODE_IDX_L_MIDDLE_LEG = _node_idx("L_middle_leg", 7)
NODE_IDX_R_MIDDLE_LEG = _node_idx("R_middle_leg", 8)